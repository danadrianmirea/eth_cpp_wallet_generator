...
namespace BIP39_WORDS {
    constexpr const char* WORDLIST[] = {
        ...
        "cupboard", "curious", "curious", "current", "curtain", "curve", "cushion", "custom", "cute", "cycle",
        ...
        "holiday", "hollow", "home", "honey", "honor", "hope", "horn", "horror", "horse", "hospital",
        ...
        "link", "lion", "liquid", "list", "little", "live", "lizard", "load", "loan", "lobby",
        ...
        "whatever", "wheat", "wheel", "when", "where", "whip", "whisper", "wide", "width", "wife",
